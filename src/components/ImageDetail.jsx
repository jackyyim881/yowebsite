...
import { FiHeart, FiShoppingCart, FiShare, FiChevronLeft, FiChevronRight } from "react-icons/fi";
...
const ImageDetail = () => {
    ...
    const [product, setProduct] = useState({
        ...
        discount: "19% off",
        description: "High quality premium fashion item made with sustainable materials. Perfect for any occasion.",
        sizes: ["XS", "S", "M", "L", "XL"],
    ...
    useEffect(() => {
        const fetchImageDetails = async () => {
            ...
            try {
                ...
                setRelatedProducts([
                    { id: "product1", image: decodedImageUrl, name: "Similar Item 1", price: "$119.99" },
                    { id: "product2", image: decodedImageUrl, name: "Similar Item 2", price: "$99.99" },
                    { id: "product3", image: decodedImageUrl, name: "Similar Item 3", price: "$139.99" },
                    { id: "product4", image: decodedImageUrl, name: "Similar Item 4", price: "$112.99" },
                ]);
        ...
        <div className="bg-white py-8 px-4 md:py-12">
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="text-sm text-gray-500 mb-6">
                    <Link to="/" className="hover:text-[#644632]">Home</Link>
                    <span className="mx-2">/</span>
                    <Link to="/product" className="hover:text-[#644632]">Product</Link>
                    <span className="mx-2">/</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="space-y-6">
                        <h1 className="text-3xl font-bold text-[#644632]">{product.name}</h1>

                        <div className="flex items-end gap-2">
                            <span className="text-2xl font-semibold text-[#644632]">{product.price}</span>
                ...
                {/* Related Products */}
                <div className="mt-16">
                    <h2 className="text-2xl font-bold text-[#644632] mb-6">You Might Also Like</h2>
